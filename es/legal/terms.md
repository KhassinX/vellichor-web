---
layout: prose
title: Vellichor — Términos de uso
...
- **Tier gratis**: tamaño limitado de biblioteca, consultas IA diarias limitadas, sin export, sin Apple Pencil, una sola plataforma
- **Desbloqueo Pro**: compra única dentro de la app, elimina los límites, todas las plataformas, Family Sharing activado

Los precios se muestran en la moneda local en la App Store al momento de la compra. Las compras las procesa Apple; los términos de pago se rigen por tu cuenta de App Store.

**No hay suscripción.** El desbloqueo Pro es una compra única. No cobramos cargos recurrentes. No ajustamos precios retroactivamente para usuarios que ya compraron.

Si estás insatisfecho con la app, los pedidos de reembolso se deben enviar a Apple a través de tu cuenta de App Store. No procesamos reembolsos directamente porque no cobramos pagos.
...
Vellichor es una app on-device. No se requiere conexión a un servidor para la funcionalidad core. El sitio web `vellichor.khassinx.com` puede no estar disponible ocasionalmente por mantenimiento u otras razones; esto no afecta a la app.

La disponibilidad de Apple Intelligence Foundation Models depende de que tu dispositivo cumpla con los requisitos de hardware y software de Apple. No controlamos las reglas de elegibilidad de Apple. Si Apple Intelligence no está disponible en tu dispositivo o tu región, las funciones de IA de Vellichor no funcionarán hasta que eso cambie.
